		...
		<svg
			...
			<g transform="matrix(.994 0 0 .994 .389 -1.445)">
				...
				<clipPath id="inkscape-original-b">
					<use xlinkHref="#inkscape-original-a" overflow="visible" />
				</clipPath>
				<g
...
const InkscapeIconButton = (props) => (
	<Button
		rightIcon={<InkscapeIcon />}
		colorScheme="teal"
		variant="solid"
		rounded="xl"
		{...props}>
		<Text marginTop={1}>InkscapeIcon</Text>
	</Button>
);
