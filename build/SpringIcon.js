...
const SpringIcon = createIcon({
  displayName: "SpringIcon",
...
const SpringIconButton = props => /*#__PURE__*/_jsx(Button, {
  rightIcon: /*#__PURE__*/_jsx(SpringIcon, {}),
  colorScheme: "teal",
  variant: "solid",
  rounded: "xl",
  ...props,
...
export { SpringIcon, SpringIconButton };