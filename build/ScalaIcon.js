...
const ScalaIcon = createIcon({
  displayName: "ScalaIcon",
...
const ScalaIconButton = props => /*#__PURE__*/_jsx(Button, {
  rightIcon: /*#__PURE__*/_jsx(ScalaIcon, {}),
  colorScheme: "teal",
  variant: "solid",
  rounded: "xl",
  ...props,
...
export { ScalaIcon, ScalaIconButton };