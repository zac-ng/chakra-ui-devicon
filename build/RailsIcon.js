...
const RailsIcon = createIcon({
	displayName: 'RailsIcon',
			...
			/*#__PURE__*/ _jsxs('g', {
				...
				children: [
					/*#__PURE__*/ _jsxs('radialGradient', {
						...
						r: '38.406',
						gradientTransform:
							'matrix(1 0 0 -1.582 -320.773 3155.877)',
						gradientUnits: 'userSpaceOnUse',
						children: [
							/*#__PURE__*/ _jsx('stop', {
								offset: '0',
...
const RailsIconButton = (props) =>
	/*#__PURE__*/ _jsx(Button, {
		rightIcon: /*#__PURE__*/ _jsx(RailsIcon, {}),
		colorScheme: 'teal',
		variant: 'solid',
		rounded: 'xl',
		...props,
...
export { RailsIcon, RailsIconButton };
